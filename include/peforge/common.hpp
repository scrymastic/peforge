...
namespace peforge {
    ...
    * @param pe_vbuffer: The base address of the PE virtual image.
    ...
    */
    bool va_to_rva(IN const BYTE* pe_vbuffer, IN DWORD pe_vsize, IN const BYTE* va, OUT DWORD &rva);

    /**
     * Convert offset to rva.
     * @param pe_rbuffer: The buffer of the raw PE file.
     * @param pe_rsize: The size of the raw PE file.
     * @param offset: The offset to convert.
     * @param rva: The relative virtual address.
     * @return: True if the conversion was successful, false otherwise.
     */
    bool offset_to_rva(IN const BYTE* pe_rbuffer, IN DWORD pe_rsize, IN DWORD offset, OUT DWORD &rva);
     ...
     * @return: True if the conversion was successful, false otherwise.
     */
    bool rva_to_offset(IN const BYTE* pe_vbuffer, IN DWORD pe_vsize, IN DWORD rva, OUT DWORD &offset);
