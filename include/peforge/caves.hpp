...
namespace peforge {
    ...
    * @param characteristics: The characteristics of the cave.
    * @return: The minimum cave.
    */
    BYTE* get_minimum_cave(IN const BYTE* pe_rbuffer, IN DWORD required_size, OUT DWORD* cave_size, IN DWORD characteristics);
}